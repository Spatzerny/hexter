...
$('document').ready(function() {
	...
	function submit(colorTrue, colorPick, colorFormat) {
		...
		$('#submit').animate({
			...
			displayResults(colorTrue, colorPick, colorFormat);
		})
	}

	function displayResults(colorTrue, colorPick, colorFormat) {
		var diff = getColorObject(
